#ifndef HOCRF_SEGMENTER_CHAR_WITH_SPACE_FEATURE_GENERATOR_H_
#define HOCRF_SEGMENTER_CHAR_WITH_SPACE_FEATURE_GENERATOR_H_
...
#endif  // HOCRF_SEGMENTER_CHAR_WITH_SPACE_FEATURE_GENERATOR_H_
