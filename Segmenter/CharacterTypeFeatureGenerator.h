#ifndef HOCRF_SEGMENTER_CHARACTER_TYPE_FEATURE_GENERATOR_H_
#define HOCRF_SEGMENTER_CHARACTER_TYPE_FEATURE_GENERATOR_H_
...
class CharacterTypeFeatureGenerator : public FeatureTemplateGenerator<UnicodeCharacter> {
public:
...
#endif  // HOCRF_SEGMENTER_CHARACTER_TYPE_FEATURE_GENERATOR_H_
