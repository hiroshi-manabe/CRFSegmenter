...
public:
    ...
    void accumulateFeatureData(std::unordered_map<FeatureTemplate, std::vector<uint32_t>> *featureTemplateToFeatureIndexListMap, std::unordered_map<Feature, uint32_t> *featureToFeatureIndexMap, std::vector<double> *featureCountList) const;
